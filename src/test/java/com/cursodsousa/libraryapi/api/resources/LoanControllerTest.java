package com.cursodsousa.libraryapi.api.resources;
...
import com.cursodsousa.libraryapi.api.resource.LoanController;
...
public class LoanControllerTest {
    ...
    public void loanedIsbnCreateLoanTest() throws Exception {
        // Cenário
        LoanDTO dto = LoanDTO.builder().isbn("123").customer("Fulano").build();
        String json = new ObjectMapper().writeValueAsString(dto);
    ...
    public void findLoansTeste() throws Exception {
        // Cenário
        Long id = 1l;
